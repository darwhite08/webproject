function data_not_found_handle() {
   const abyMainContainer = document.getElementById('aby-result-container');
    abyMainContainer.innerHTML = ' ';
    const noDataDiv = document.createElement('div');
    noDataDiv.classList.add('no-results', 'text-center', 'py-5');
    noDataDiv.innerHTML = `

      <div class="grid gap-4 w-72 rounded-3xl px-8 py-4 bg-white">
      ...
      <div>
      <h2 class="text-center text-black text-base font-semibold leading-relaxed pb-1">There’s no items here</h2>
      <p class="text-center text-black text-sm font-normal leading-snug pb-4">Try changing your filters to <br />see anime </p>
    ...
    `;
    abyMainContainer.appendChild(noDataDiv);
}
